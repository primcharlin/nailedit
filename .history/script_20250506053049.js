...
function showCharacterSelection(mode) {
    ...
    customizationUI.innerHTML = `
        <div class="customization-preview">
            <img id="character-preview" src="img/avatar-light-long-brown.png" alt="Character Preview">
        </div>
    ...
    // Replace existing character grid with customization UI
    const characterGrid = document.querySelector('.character-grid');
    characterGrid.replaceWith(customizationUI);
...
function updateCharacterPreview() {
    ...
    previewImg.src = `img/avatar-${skinTone}-${hairStyle}-${eyeColor}.png`;
}
...
function selectCustomCharacter() {
    ...
    characterDisplay.innerHTML = `<img src="img/avatar-${skinTone}-${hairStyle}-${eyeColor}.png" alt="Custom Character">`;
