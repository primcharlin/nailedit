...
function showCharacterSelection(mode) {
    ...
    // Keep the existing character grid but add customization option
    ...
    customOption.addEventListener('click', showCustomizationUI);
}
...
function showCustomizationUI() {
    ...
    // Hide character grid and show customization UI
    characterGrid.style.display = 'none';
    document.querySelector('#character-selection h1').insertAdjacentElement('afterend', customizationUI);
